...
if __name__ == "__main__":
    ...
    config = MultiModalTimerConfig(
        forecasting_length=args.forecasting_length,
        vision_model_name =args.vision_model_name,
        vision_model_path=args.vision_model_path,
        text_model_name =args.text_model_name,
        text_model_path=args.text_model_path,
        timer_path=args.timer_path,
        vision_model_prompt_len=args.vision_model_prompt_len,
        text_model_prompt_len=args.text_model_prompt_len,
        timer_prompt_len=args.timer_prompt_len,
        )
    model = MultiModalTimerModel(config)

    train_dataset = MultiModalTimerDataset(dataset_path=os.path.join(args.dataset_path, "train"), vision_model_name=args.vision_model_name, dataset_text=args.dataset_text, forecasting_length=args.forecasting_length)
    val_dataset = MultiModalTimerDataset(os.path.join(args.dataset_path, "val"), vision_model_name=args.vision_model_name, dataset_text=args.dataset_text, forecasting_length=args.forecasting_length)
